...
function dashboard(id, fData){
    ...
    function pieChart(pD){
        ...
        function mouseover(d){
            ...
            hG.update(fData.map(function(v){ 
                return [v.charge,v.freq[d.data.type]];}),segColor(d.data.type));
        }
        //Utility function to be called on mouseout a pie slice.
        function mouseout(d){
            // call the update function of histogram with all data.
            hG.update(fData.map(function(v){
                return [v.charge,v.total];}), barColor);
        }
    ...
    // calculate total frequency by charges for all segment.
    var sF = fData.map(function(d){return [d.charge,d.total];});
